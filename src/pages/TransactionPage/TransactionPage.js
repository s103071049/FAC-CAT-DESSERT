...
const Column = styled.th`
  ...
  ${MEDIA_QUERY_MD} {
    ...
    &:nth-of-type(1):before {content: '訂單編號'};
    &:nth-of-type(2):before {content: '總金額'};
    &:nth-of-type(3):before {content: '收件者'};
    &:nth-of-type(4):before {content: '交易日期'};
    &:nth-of-type(5):before {content: '收貨日期'};
    &:nth-of-type(6):before {content: '處理情形'};
    &:nth-of-type(7):before {content: '繳款情形'};
  }
`
